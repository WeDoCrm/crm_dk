Public Class FRM_CUSTOMER
    ...
    Private Sub FRM_CUSTOMER_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            dt1 = DoQueryNoErrorCatch(gsConString, SQL_TEMP)
    ...
    Public Sub gsSelect()
        ...
        Try
            ...
            Dim dt2 As DataTable = DoQueryNoErrorCatch(gsConString, SQL_TEMP)
    ...
    Private Sub CopyClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTelNoCpy.Click, btnHPCpy.Click, btnFaxCpy.Click
